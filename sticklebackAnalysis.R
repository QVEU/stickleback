library(ggplot2)
library(readr)
inputdir="/Volumes/LVD_QVE/Sequencing_Data/QVEU_Seq_0017_MiSeq_InsertionalHandleLibraries/220919_M02211_0080_000000000-KCVTP/Data/Intensities/BaseCalls/NGmergedreads/Insertional_Handle_P1_RepA"
